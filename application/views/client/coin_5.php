    ...
    <div class="main-container">
        <div class="main-container-wrap">
            <div class="main-content" style="background-color:white;">
                ...
                <div class="el-row">
                    <iframe src='https://bepick.net/live/coinpower5/scrap' width='789' height='609' scrolling='no' frameborder='0' style="width: 830px; height: 609px;">
                    </iframe>
                        ...
                        <div class="el-table__body-wrapper is-scrolling-none" style="height: 459px;">
                            <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 760px;">
                                <colgroup>
                                    ...
                                    <col name="el-table_1_column_3" width="150"><col name="el-table_1_column_4" width="60">
                                    <col name="el-table_1_column_5" width="100"><col name="el-table_1_column_6" width="80">
                                    <col name="el-table_1_column_7" width="80"><col name="el-table_1_column_8" width="60">
                                </colgroup>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/coin.js?v=3'); ?>"></script>
