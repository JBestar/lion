    ...
    <div class="main-container">
        <div class="main-container-wrap">
            <div class="main-content" style="background-color:white;">
                ...
                <div class="el-row">
                    <iframe src='https://bepick.net/live/eosball5m' width='789' height='609' scrolling='no' frameborder='0' style="width: 830px; height: 609px;">
                    </iframe>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/eos.js?v=3'); ?>"></script>
